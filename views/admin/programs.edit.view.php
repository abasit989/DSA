...
<main>
        <section class="add-products">
            ...
            <h1 class="heading">POST PROGRAMS</h1>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <input type="hidden" name="date" class="box">
                    </div>
        
                <input type="submit" value="post program" class="btn">
            </form>
    
        </section><br>
        <section class="show-products">
    
            <h1 class="heading">posted programs</h1>
        </section>
        <?php foreach($model as $info) : ?>
            ...
            <div class="news-container">
                ...
                <div class="news-details">
                    ...
                    <div>
                        <a href="change.programs.php?key=<?=$info->id?>"><button class="button">edit</button>
                        </a>
                        <a href="delete.programs.php?key=<?=$info->id?>"><button class="button" style="background-color: var(--RED)" >Delete</button>
                        </a>
                    </div>
                </div>
            </div>
